...
class CalendarDay extends Component {
  ...
  renderMarking() {
    ...
    if (
      marking.emoji &&
      Array.isArray(marking.emoji) &&
      marking.emoji.length > 0
    ) {
      return this.renderEmoji(marking);
    }
  ...
  renderEmoji(marking) {
    return (
      <Text style={{fontSize: 14}}>{marking.emoji[0].text}</Text>
    )
  }
          ...
          <View style={[]}>
            ...
            {showDayNumber && (
              ...
              >
                <View
                  style={[
                    { fontSize: dateNumberFontSize, overflow: "hidden" },
                    _dateNumberStyle,
                    {
                      width: 50,
                      height: 50,
